...
class KNearestNeighbor(object):
  ...
  def compute_distances_two_loops(self, X):
    ...
    print("length of dimentions: " + str(len(self.X_train[0])))
  ...
  def compute_distances_no_loops(self, X):
    ...
    twoAB = 2 * X.dot(self.X_train.T)
    dists = np.sqrt(a + b - twoAB)
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
    return dists
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in range(num_test):
      ...
      #########################################################################
      sortedI = np.argsort(dists[i])
      closest_y = self.y_train[sortedI][:k] # gets all the labels sorted with distance till index k - 1
      #########################################################################
      # TODO:                                                                 #
